 ...
 */
public class XilmassStarter {

    /**
     * Logger instance.
     */
    private static final Logger LOGGER = Logger.getLogger(XilmassStarter.class);
    ...
    public static void main(final String[] args) {
        ...
        XilmassStarter xilmassStarter = new XilmassStarter();
        xilmassStarter.launch();
    }
