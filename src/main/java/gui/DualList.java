...
public class DualList<T> extends javax.swing.JPanel {
    ...
    public List<T> getAddedItems() {
        ...
        addedItems.addAll(addedItemBindingList);
        return addedItems;
    }
    ...
    public List<T> getAvailableItems() {
        ...
        availableItems.addAll(availableItemBindingList);
    ...
    public List<T> getAllItems() {
        ...
        allItems.addAll(addedItemBindingList);
        allItems.addAll(availableItemBindingList);
        return allItems;
    }
    ...
    public void init(Comparator<? super T> comparator) {
        ...
        availableItemBindingList = (ObservableList<T>) ObservableCollections.observableList(new ArrayList<>());
        ...
        addedItemBindingList = (ObservableList<T>) ObservableCollections.observableList(new ArrayList<>());
