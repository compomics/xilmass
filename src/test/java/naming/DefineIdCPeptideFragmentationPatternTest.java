...
public class DefineIdCPeptideFragmentationPatternTest {
    ...
    public void testGetName_LINEAR() {
        ...
        matchedCPepPeaks.add(new CPeptidePeak(849.4174, 100, 2, "doublyCharged_pepA_x5"));//14
...
//        matchedCPepPeaks.add(new CPeptidePeak(529.2818, 100, 2, "doublyCharged_pepA_a4_lepB_a4"));//8
        ...
        matchedCPepPeaks = new ArrayList<CPeptidePeak>();
        matchedCPepPeaks.add(new CPeptidePeak(131.0815, 100, 1, "singlyCharged_pepA_a2"));
        matchedCPepPeaks.add(new CPeptidePeak(130.5656, 100, 2, "doublyCharged_pepA_a3"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepA_a4"));
        matchedCPepPeaks.add(new CPeptidePeak(620.8666, 100, 2, "doublyCharged_pepA_b6"));
        matchedCPepPeaks.add(new CPeptidePeak(1240.725, 100, 1, "singlyCharged_pepA_b6"));
        matchedCPepPeaks.add(new CPeptidePeak(573.2627, 100, 1, "singlyCharged_pepA_x4"));
        matchedCPepPeaks.add(new CPeptidePeak(287.1349, 100, 2, "doublyCharged_pepA_x4"));
        matchedCPepPeaks.add(new CPeptidePeak(175.1189, 100, 2, "singlyCharged_pepA_y1"));
        matchedCPepPeaks.add(new CPeptidePeak(304.1615, 100, 2, "singlyCharged_pepA_y2"));
        matchedCPepPeaks.add(new CPeptidePeak(419.1884, 100, 1, "singlyCharged_pepA_y3"));
        matchedCPepPeaks.add(new CPeptidePeak(547.2834, 100, 1, "singlyCharged_pepA_y4"));
        matchedCPepPeaks.add(new CPeptidePeak(274.1453, 100, 2, "doublyCharged_pepA_y4"));
        matchedCPepPeaks.add(new CPeptidePeak(686.4013, 100, 2, "doublyCharged_pepA_y6"));
        matchedCPepPeaks.add(new CPeptidePeak(750.9226, 100, 2, "doublyCharged_pepA_y7"));
        matchedCPepPeaks.add(new CPeptidePeak(794.4386, 100, 1, "doublyCharged_pepA_y8"));
        ...
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepB_y1"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepB_a4"));
        instance = new DefineIdCPeptideFragmentationPattern(matchedCPepPeaks, 5, 3, 9, 4);
    ...
    public void testGetName_MONOLINK() {
        ...
        matchedCPepPeaks.add(new CPeptidePeak(287.1349, 100, 2, "doublyCharged_pepA_x4"));
        matchedCPepPeaks.add(new CPeptidePeak(175.1189, 100, 2, "singlyCharged_pepA_y1"));
        matchedCPepPeaks.add(new CPeptidePeak(629.314, 100, 2, "singlyCharged_pepA_b5_lepB_monolink_b3"));
        ...
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepB_y1"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepB_a4"));
        matchedCPepPeaks.add(new CPeptidePeak(629.314, 100, 2, "singlyCharged_pepB_b5_lepA_monolink_b3"));
        instance = new DefineIdCPeptideFragmentationPattern(matchedCPepPeaks, 5, 3, 9, 4);
    ...
    public void testGetName_LEFTU() {
        ...
        ArrayList<CPeptidePeak> matchedCPepPeaks = new ArrayList<CPeptidePeak>();
        matchedCPepPeaks = new ArrayList<CPeptidePeak>();
        matchedCPepPeaks.add(new CPeptidePeak(228.1342, 100, 1, "singlyCharged_pepA_a1"));
        ...
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepB_a1"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepB_a3"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepA_a7"));
        instance = new DefineIdCPeptideFragmentationPattern(matchedCPepPeaks, 5, 3, 9, 4);
        ...
        matchedCPepPeaks.add(new CPeptidePeak(228.1342, 100, 1, "singlyCharged_pepA_a1"));
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepA_b2"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepA_a3"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepA_b1"));
        matchedCPepPeaks.add(new CPeptidePeak(228.1342, 100, 1, "singlyCharged_pepB_b2"));
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepB_a1"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepB_a3"));
    ...
    public void testGetName_LEFT_CHAIR() {
        ...
        matchedCPepPeaks.add(new CPeptidePeak(228.1342, 100, 1, "singlyCharged_pepB_y1"));
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepB_a4"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepB_x3"));
        instance = new DefineIdCPeptideFragmentationPattern(matchedCPepPeaks, 5, 3, 9, 4);
        ...
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepB_a4"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepB_x3"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepB_a2")); // only one ion on the other arm..       
        instance = new DefineIdCPeptideFragmentationPattern(matchedCPepPeaks, 5, 3, 9, 4);
        expResult = IdCPeptideFragmentationPatternName.LEFT_CHAIR_PEPB;
        result = instance.getName();
        assertEquals(expResult, result);
        ...
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepB_a4"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepB_x3"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepB_a2"));
        matchedCPepPeaks.add(new CPeptidePeak(629.314, 100, 2, "singlyCharged_pepB_b5_lepA_monolink_b3"));
        instance = new DefineIdCPeptideFragmentationPattern(matchedCPepPeaks, 5, 3, 9, 4);
        expResult = IdCPeptideFragmentationPatternName.LEFT_CHAIR_PEPB;
        result = instance.getName();
    ...
    public void testINTACT() {
        ...
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepA_a4"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepA_b4"));
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepA_y2"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepA_x4"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepA_y4"));

        matchedCPepPeaks.add(new CPeptidePeak(228.1342, 100, 1, "singlyCharged_pepB_b2"));
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepB_a1"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepB_a3"));

        matchedCPepPeaks.add(new CPeptidePeak(228.1342, 100, 1, "singlyCharged_pepB_y5"));
        matchedCPepPeaks.add(new CPeptidePeak(228.1342, 100, 1, "singlyCharged_pepB_x5"));
    ...
    public void testGetName_RIGHTU() {
        ...
        matchedCPepPeaks = new ArrayList<CPeptidePeak>();
        matchedCPepPeaks.add(new CPeptidePeak(228.1342, 100, 1, "singlyCharged_pepA_a6"));
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepA_b8"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepA_y1"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepA_x1"));
        matchedCPepPeaks.add(new CPeptidePeak(228.1342, 100, 1, "singlyCharged_pepB_a4"));
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "singlyCharged_pepB_y1"));
        matchedCPepPeaks.add(new CPeptidePeak(159.0764, 100, 2, "doublyCharged_pepB_x1"));
        DefineIdCPeptideFragmentationPattern instance = new DefineIdCPeptideFragmentationPattern(matchedCPepPeaks, 5, 3, 9, 4);
...
//        singlyCharged_pepB_x2_lepA_x3_mz = 883.4155
    ...
    public void testGetName_Problem() {
        ...
        assertEquals(expResult, result);
         ...
         matchedCPepPeaks = new ArrayList<CPeptidePeak>();
        matchedCPepPeaks.add(new CPeptidePeak(228.1342, 100, 1, "doublyCharged_pepA_a7"));
        matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "doublyCharged_pepB_b9_lepA_b8"));
                matchedCPepPeaks.add(new CPeptidePeak(147.1128, 100, 1, "doublyCharged_pepB_a9_lepA_a10"));
