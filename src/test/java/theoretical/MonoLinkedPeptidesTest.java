...
public class MonoLinkedPeptidesTest {
    ...
    public void testGetTheoretical_xlinked_mass() {
        ...
        MonoLinkedPeptides instance = new MonoLinkedPeptides(peptide, "test", 1, new DSS(), FragmentationMode.HCD_all);
    ...
    public void testGetTheoretical_ions() {
        ...
        Peptide peptide = new Peptide("AKLMR", new ArrayList<ModificationMatch>());
        MonoLinkedPeptides instance = new MonoLinkedPeptides(peptide, "test", 1, new DSS(), FragmentationMode.CID);
