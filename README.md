...
Xilmass provides a user-friendly a graphical user interface (GUI) to run cross-linked peptides identifications. Additionally, it also offers the command line version allows automation.
...
You can run Xilmass both as user-friendly GUI or command line versions. 
